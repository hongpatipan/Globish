<template>
  <div class="card-container">
    ...
    <div class="btn-footer">
      ...
      >
      <router-link to="/ex7" :class="{ 'non-clickable': !selectedChoice }">
...
export default defineComponent({
  ...
  setup() {
    ...
    const selectedChoiceFromEx5 = ref(null);

    if (store.getters.getSelectedChoice5) {
      selectedChoiceFromEx5.value = store.getters.getSelectedChoice5;
    }

    console.log("selectedChoiceFromEx5", selectedChoiceFromEx5.value);
    ...
    const selectChoice = (choiceValue: number) => {
      ...
      if (
        selectedChoiceFromEx5.value !== null &&
        selectedChoice.value !== null
      ) {
        totalValue.value = selectedChoiceFromEx5.value + selectedChoice.value;
