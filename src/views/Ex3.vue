<template>
  <div class="card-container">
    ...
    <div class="card">
      <h1>Q3</h1>
      <h2>สไตล์การเรียนภาษาอังกฤษของคุณ เป็นแบบไหน?</h2>
      <div class="choices">
    ...
    <div class="btn-footer">
      ...
      >
      <router-link to="/ex4" :class="{ 'non-clickable': !selectedChoice }">
...
export default defineComponent({
  ...
  setup() {
    ...
    const selectedChoiceFromEx2 = ref(null);

    if (store.getters.getSelectedChoice2) {
      selectedChoiceFromEx2.value = store.getters.getSelectedChoice2;
    }

    console.log("selectedChoiceFromEx2", selectedChoiceFromEx2.value);
    ...
    const selectChoice = (choiceValue: number) => {
      ...
      if (
        selectedChoiceFromEx2.value !== null &&
        selectedChoice.value !== null
      ) {
        totalValue.value = selectedChoiceFromEx2.value + selectedChoice.value;
        store.dispatch("updateSelectedChoice3", totalValue);
